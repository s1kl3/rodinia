...
#include "./kernel_cpu_opencl_wrapper_2.h"				// (in directory provided here)
...
void 
kernel_cpu_opencl_wrapper_2(knode *knodes,
							long knodes_elem,
							long knodes_mem,
							...
							int *reclength)
{
	...
	const char *source = load_kernel_source("./kernel/kernel_cpu_opencl_2.cl");
